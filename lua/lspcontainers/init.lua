...
local supported_languages = {
    bashls = { image = "docker.io/atidyshirt/bashls" },
    clangd = { image = "docker.io/atidyshirt/clangd" },
    gopls = {
        ...
        image = "docker.io/atidyshirt/gopls",
    },
    jsonls = { image = "docker.io/atidyshirt/jsonls" },
    lua_ls = { image = "docker.io/atidyshirt/lua_ls" },
    pylsp = { image = "docker.io/atidyshirt/pylsp" },
    rust_analyzer = { image = "docker.io/atidyshirt/rust_analyzer" },
    ts_ls = { image = "docker.io/atidyshirt/ts_ls" },
    yamlls = { image = "docker.io/atidyshirt/yamlls" },
}
